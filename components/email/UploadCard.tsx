...
export default function UploadEmailCard({ selectCategory }: UploadEmailProp) {
  ...
  return (
    <Card className="w-[20rem]  border-2 p-4 flex flex-col justify-between border-orange-400">
      <CardHeader>
        <div className="space-y-2 flex flex-col items-center">
          <Label htmlFor="category" className="text-sm ">
            Upload Csv To Add Email
          </Label>
      ...
      <CardFooter className="flex items-center justify-center ">
        <Button onClick={()=>handleSubmitEmails()} disabled={loading} variant="outline" size="sm">
          Save 
